...
const questions = [
    ...
    {
        title : 'In computer world,Trojan refer to?',
        options : [
            'Virus',
            'Malware',
            'Worm',
    ...
    {
        title : 'What is the full form of RAM?',
        options : [
            'Read Access Memory',
    ...
    {
        title : 'What is the full form of IP?',
        options : [
            'Interface program',
            'Interface protocol',
            'Internet program',
    ...
    {
        title : 'Which of the following is not a computer language?',
        options : [
            'BASIC',
            'LOTUS',
            'C++',
    ...
    {
        title : 'What is the full form of PHP?',
        options : [
